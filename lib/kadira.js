...
Kadira._sendAppStats = function () {
  ...
  console.warn('appStats', toLog);
  fs.appendFileSync('./apm.log', JSON.stringify(toLog));
  // TODO: send appStats here.
}
...
Kadira._sendPayload = function (callback) {
  new Fibers(function() {
    ...
    fs.appendFileSync('./apm.log', JSON.stringify(payload));
    // TODO: Send payload here.
  }).run();
}
